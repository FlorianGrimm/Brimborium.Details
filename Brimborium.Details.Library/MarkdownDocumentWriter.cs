...
public class MarkdownDocumentWriter {
    private readonly DetailContext _DetailContext;
    ...
    public MarkdownDocumentWriter(
        ...
        this._DetailContext = detailContext;
    ...
    public DetailContext DetailContext => this._DetailContext;
    ...
    public async Task WriteAsync(CancellationToken cancellationToken) {
        ...
        if (this.MarkdownContent.Equals(newContent)) {
            ...
            await this._FileSystem.WriteAllTextAsync(this.MarkdownDocumentInfo.FileName, UTF8Encoding.UTF8, newContent, cancellationToken);
        }
    }
