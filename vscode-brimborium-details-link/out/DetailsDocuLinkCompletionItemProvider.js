...
exports.DetailsDocuLinkCompletionItemProvider = void 0;
const regExpDetailscode = new RegExp("detailscode://([^ #]*)([#][1-9]*)?([§].*)?", "g");
class DetailsDocuLinkCompletionItemProvider {
    constructor(state) {
        this.state = state;
    }
    /**
...
exports.DetailsDocuLinkCompletionItemProvider = DetailsDocuLinkCompletionItemProvider;
//# sourceMappingURL=DetailsDocuLinkCompletionItemProvider.js.map