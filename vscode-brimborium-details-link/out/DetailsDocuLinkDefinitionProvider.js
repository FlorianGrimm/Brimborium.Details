...
exports.DetailsDocuLinkDefinitionProvider = void 0;
 ...
 *
 */
class DetailsDocuLinkDefinitionProvider {
    constructor(state) {
        this.state = state;
        const e = "details://([^)#]*)([#][1-9]*)?([§].*)?";
    ...
    provideDocumentLinks(document, token) {
        ...
        const workspaceState = this.state.getWorkspaceStateByFileName(document.fileName);
        const links = [];
        let match;
...
exports.DetailsDocuLinkDefinitionProvider = DetailsDocuLinkDefinitionProvider;
//# sourceMappingURL=DetailsDocuLinkDefinitionProvider.js.map