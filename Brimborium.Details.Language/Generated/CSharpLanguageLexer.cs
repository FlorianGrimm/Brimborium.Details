...
public partial class CSharpLanguageLexer : Lexer {
	...
	public CSharpLanguageLexer(ICharStream input)
	: this(input, Console.Out, Console.Error) { }

	public CSharpLanguageLexer(ICharStream input, TextWriter output, TextWriter errorOutput)
